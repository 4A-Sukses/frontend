...
class AIAnalysisService {
  ...
  async analyzeLearningPattern(stats: ActivityStats): Promise<LearningAnalysis | null> {
    try {
  ...
  async generateQuizQuestions(materialContent: string, count: number = 5): Promise<any[]> {
    // TODO: Implement as API route if needed
